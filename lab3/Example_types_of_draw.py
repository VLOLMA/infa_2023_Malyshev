...
while not done:
    ...
    pygame.draw.line(screen, (60, 179, 113), [0, 0], [150, 130], 5)
    ...
    pygame.draw.aaline(screen, (60, 179, 200), [0, 50], [350, 480], True)

    # Draw on the screen 3 black lines, each 5 pixels wide.
    # The 'False' means the first and last points are not connected.
    pygame.draw.lines(
        screen, "black", False, [[0, 80], [50, 90], [200, 80], [220, 30]], 20
    )

    # Draw a rectangle outline
    pygame.draw.rect(screen, "black", [75, 30, 50, 20], 1)

    # Draw a solid rectangle. Same color as "black" above, specified in a new way
    pygame.draw.rect(screen, (0, 0, 0), [150, 10, 50, 20])

    # Draw a rectangle with rounded corners
    pygame.draw.rect(screen, "blue", [115, 210, 70, 40], 10, border_radius=30)
    pygame.draw.rect(
        screen,
        "red",
        [135, 260, 50, 30],
